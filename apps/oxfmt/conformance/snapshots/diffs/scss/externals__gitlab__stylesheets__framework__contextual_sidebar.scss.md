# externals/gitlab/stylesheets/framework/contextual_sidebar.scss
...
@mixin sub-level-items-flyout {
  .sidebar-sub-level-items {
    @include media-breakpoint-up(sm) {
      ...
      box-shadow:
        0 $gl-spacing-scale-2 $gl-spacing-scale-5 $t-gray-a-24,
        0 0 $gl-spacing-scale-1 $t-gray-a-24;
      border-style: none;
...
.nav-sidebar {
  ...
  transition:
    ...
    left $gl-transition-duration-medium;
  z-index: 600;
